    ...
    const validateFile = () => {
        ...
        for (let i = 1; i < file.length; i++) {
            ...
            if (!validateLength(iccid, 19)) {
                errorsArray.push(`Error en la linea ${i}, el campo 'ICCID' no posee 19 caracteres.`)
            }

            if (!validateIntField(iccid)) {
                errorsArray.push(`Error en la linea ${i}, el campo 'ICCID' no es de tipo numerico.`)
            }
            ...
            if (i === 0) {
                ...
                const iccidRepited = validateRepited(processArray, "iccid", iccid)
                if (iccidRepited) {
                    errorsArray.push(`Error en la linea ${i}, el campo 'ICCID' se encuentra repetido.`)
                }
                processArray.push(rowProcessed)
            }
        }
