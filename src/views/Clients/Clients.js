...
export default function Clients(props) {
          ...
          <Button
            ...
            onClick={() => {
              setClientEdit({
                ...cl,
                tipoIdentificacion:
                  cl.identificacion.length === 13 ? "RUC" : "CI"
              });
              setClientEditAux({
                ...cl,
                tipoIdentificacion:
  ...
  const validateForm = () => {
    let errorMessage = "";
    if (
      client.tipoIdentificacion === "RUC" &&
      client.identificacion.length !== 13
    ) {
      errorMessage = "El numero de identificacion no tiene 13 carcteres. ";
    }
    if (
      client.tipoIdentificacion === "CI" &&
      client.identificacion.length !== 10
    ) {
      errorMessage = "El numero de identificacion no tiene 10 carcteres. ";
    }
    if (
      clients.clients.filter(cl => cl.identificacion === client.identificacion)
        .length > 0
    ) {
      errorMessage =
        errorMessage + "Ya existe un cliente con ese numero de identificacion";
    }
  ...
  const validateEditForm = () => {
    if (clientEdit.identificacion !== clientEditAux.identificacion) {
      let errorMessage = "";
      if (
        clientEdit.tipoIdentificacion === "RUC" &&
        clientEdit.identificacion.length !== 13
      ) {
        errorMessage = "El numero de identificacion no tiene 13 carcteres. ";
      }
      if (
        clientEdit.tipoIdentificacion === "CI" &&
        clientEdit.identificacion.length !== 10
      ) {
        errorMessage = "El numero de identificacion no tiene 10 carcteres. ";
      }
      if (
        clients.clients.filter(
          cl => cl.identificacion === clientEdit.identificacion
        ).length > 0
      ) {
        errorMessage =
          errorMessage +
  ...
  return (
    <AdminLayout>
          ...
          <form>
            <FormControl fullWidth className={FormClasses.selectFormControl}>
              ...
              <Select
                ...
                onChange={e =>
                  handleClientChange("tipoIdentificacion", e.target.value)
                }
                inputProps={{
            ...
            <CustomInput
              ...
              onChange={e =>
                handleClientChange("identificacion", e.target.value)
              }
            />
            <CustomInput
              labelText="Nombre"
      ...
      >
        ...
        >
          <h3 className={modalClasses.modalTitle}>
            Editar cliente <b>{clientEditAux.nombre_completo}</b>
          </h3>
        </DialogTitle>
        <DialogContent
          id="modal-slide-description"
          ...
          <form>
            <FormControl fullWidth className={FormClasses.selectFormControl}>
              ...
              <Select
                ...
                onChange={e =>
                  handleClientEditChange("tipoIdentificacion", e.target.value)
                }
                inputProps={{
            ...
            <CustomInput
              ...
              onChange={e =>
                handleClientEditChange("identificacion", e.target.value)
              }
            />
            <CustomInput
              labelText="Nombre"
              ...
              onChange={e =>
                handleClientEditChange("nombre_completo", e.target.value)
              }
      ...
      >
        ...
        >
          <h3 className={modalClasses.modalTitle}>
            Eliminar cliente <b>{clientEditAux.nombre_completo}</b>
          </h3>
        </DialogTitle>
        <DialogContent
          id="modal-slide-description"
      ...
      >
          ...
          >
            ...
            <ul>
              {file && file.length > 0 && (
                <li>
                  <h4>
                    <b>Resgistros encontrados:</b> {file && file.length}
                  </h4>
                </li>
              )}
              {errors && errors.length > 0 && (
                <li>
                  <h4>
                    <b>Errores:</b> {errors && errors.length}
                  </h4>
                </li>
              )}
            </ul>
            {errors && errors.length > 0 && (
              <Button color="danger" onClick={() => setModalErros(true)}>
                Ver Errores
              </Button>
            )}
          </div>
        ...
        >
          {file && file.length > 0 && (
            <Button color="success" onClick={processFile}>
              Procesar Archivo
            </Button>
          )}
